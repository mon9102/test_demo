...
public class PgpUtils {
    ...
    public static void main(String [] args) {
        ...
        String filePath = "D:/MyWork/00_文档/23_Aviva/加解密/source.txt";
        String publicKeyPath = "D:/MyWork/00_文档/23_Aviva/加解密/DBSSG_EN_PUBLIC.asc";
        String signFilePath = "D:/MyWork/00_文档/23_Aviva/加解密/sign.txt";
//    	PgpUtils.verifySignature(filePath, publicKeyPath, signFilePath);
        ...
        try {
            ...
            FileOutputStream outputFile = new FileOutputStream(signFilePath);
//	        bl.decryptFile(in, outputFile, keyIn, "1qaz2wsx".toCharArray());
//	        System.out.println(FileUtils.readFileToString(outputFile));

            bl.encryptFile(outputFile,filePath,bl.readPublicKey(keyIn),true,true);
