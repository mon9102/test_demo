...
public class GenerateTestUserSig {
     ...
     * 它是腾讯云用于区分客户的唯一标识。
     */
    public static final int SDKAPPID = 1400262617;
     ...
     */
    private static final String SECRETKEY = "5cf190c1ef1baac50dfe4c941cf689b73019877cba5d011529f13c4da5ba5d97";
    ...
    private static String GenTLSSignature(long sdkappid, String userId, long expire, byte[] userbuf, String priKeyContent) {
        ...
        if (null != userbuf) {
            base64UserBuf = encodeToString(userbuf);
            try {
    ...
    private static byte[] base64EncodeUrl(byte[] input) {
        byte[] base64 = encodeToString(input).getBytes();
     ...
     * @return
     */
    private static String encodeToString(byte[] textByte) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println( GenerateTestUserSig.genTestUserSig("1"));
        System.out.println( GenerateTestUserSig.genTestUserSig("2"));
    }
